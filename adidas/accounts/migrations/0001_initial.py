    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.TextField(blank=True, max_length=200, null=True, verbose_name='Имя')),
                ('last_name', models.TextField(blank=True, max_length=200, null=True, verbose_name='Фамилия')),
